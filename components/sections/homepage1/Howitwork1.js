                ...
                <div className="container">
                    <div className="text-center"><img className="mb-15" src="/autoniukas_icon.svg" alt="autoniukas" style={{ height: '50px' }} />
                        ...
                        <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">Jūs pasirenkate miestus, į kuriuos
                            ...
                            pristatymo sprendimą, kad užtikrintume laiku atliktą pristatymą.</p>
                    </div>
                                ...
                                <div className="box-info-bottom-img">
                                    <div className="info-play">
                                        <h4 className="color-white mb-15 wow animate__animated animate__fadeIn">Turime 25 metų
                                            patirtį šioje srityje</h4>
                                        <p className="font-sm color-white wow animate__animated animate__fadeIn">Mes siūlome įvairius
                                            sprendimus, pritaikytus jūsų poreikiams.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <li>
                                    ...
                                    <div className="info-how">
                                        <h5 className="color-brand-2 wow animate__animated animate__fadeIn">Klientas pateikia
                                            užsakymą</h5>
                                        <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">Prekių patikrinimas
                                            ir kokybės kontrolė</p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className="info-how">
                                        ...
                                        <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">Payoneer,
                                            Paypal, arba Visa master card</p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className="info-how">
                                        <h5 className="color-brand-2 wow animate__animated animate__fadeIn">Sandėlis gauna
                                            užsakymą</h5>
                                        <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">Prekių tikslumo
                                            patikrinimas.</p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className="info-how">
                                        <h5 className="color-brand-2 wow animate__animated animate__fadeIn">Prekė paimta, supakuota
                                            ir išsiųsta</h5>
                                        <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">Prekių perdavimas
                                            vietiniam vežėjui</p>
                                    </div>
                                </li>
                                <li>
                                    ...
                                    <div className="info-how">
                                        <h5 className="color-brand-2 wow animate__animated animate__fadeIn">Pristatyta ir įvertinta
                                            sėkmė</h5>
                                        <p className="font-md color-grey-700 wow animate__animated animate__fadeIn">Užsakymo būsenos
                                            atnaujinimas sistemoje</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
