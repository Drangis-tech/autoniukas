                ...
                <div className="container">
                    <div className="box-map">
                        ...
                        <div className="map-info"><img className="mb-25 wow animate__animated animate__fadeIn" src="/autoniukas.png" alt="transp" style={{ height: '50px' }} />
                            <p className="color-grey-700 mb-25 wow animate__animated animate__fadeIn">Kovo 11-osios g. 5, Šilalė, 75135 Šilalės r. sav.</p>
                            <p className="color-grey-700 mb-10 wow animate__animated animate__fadeIn">
                                ...
                                </svg>Tel.: <a href="tel:+37063881847">+370 638 81847</a>, <a href="tel:+37063094599">+370 630 94599</a>
                            </p>
                            <p className="color-grey-700 mb-30 wow animate__animated animate__fadeIn">
                                ...
                                </svg>El. paštas: <a href="mailto:niukasauto@gmail.com">niukasauto@gmail.com</a>
                            </p>
                            <div className="line-border mb-25 wow animate__animated animate__fadeIn" />
                            <p className="color-grey-700 font-md-bold wow animate__animated animate__fadeIn">Darbo laikas: 8:00 -
                                17:00, Pr - Šeš</p>
                        </div>
                    </div>
                </div>
