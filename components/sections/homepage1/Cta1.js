                    ...
                    <div className="box-get-quote">
                        <div className="get-quote-left">
                            <p className="font-3xl color-white mb-10 wow animate__animated animate__fadeIn">
                                {isEnglish ? 'Have ideas?' : 'Turite idėjų?'}
                            </p>
                            <h2 className="color-white wow animate__animated animate__fadeIn">
                                {isEnglish ? 'Let\'s start cooperation today' : 'Pradėkime bendradarbiavimą jau šiandien'}
                            </h2>
                        </div>
                        <div className="get-quote-right">
                            <Link className="btn btn-get-quote wow animate__animated animate__fadeIn" href={isEnglish ? '/en/contact' : '/contact'}>
